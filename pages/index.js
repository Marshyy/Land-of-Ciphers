...
const Home = () => {
  return (
    <div className=" flex   flex-col items-center  justify-center   lg:h-90vh">
      ...
      <div class="flex w-full flex-col  items-center px-3 lg:flex-row lg:px-20 ">
        <div class="hidden h-full w-1/4 flex-col items-center justify-center border-r-1 border-brandDarkGreen px-10 py-10 lg:flex ">
          ...
          <div class="my-10 h-64 w-full rounded-md bg-brandLightBlue"></div>
        </div>
        <div class=" h-full w-full  py-10 lg:w-3/4 lg:px-10 ">
            ...
            <div className=" flex w-full flex-col items-center justify-center py-5 text-sm text-gray-500 hover:text-white lg:w-1/2 lg:px-5 ">
              ...
              >
                <div class="h-full w-2/3">
                  <div className="my-2 text-xl font-semibold text-gray-600  ">
