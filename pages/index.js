  ...
  return (
    <div className=" overflow-x-hidden ">
      <div className=" flex   flex-col items-center  justify-center   ">
        ...
        <div class="flex w-full flex-col items-center px-3 lg:h-90vh lg:flex-row lg:px-20 lg:py-10 ">
          <div class="hidden h-full w-1/4 flex-col items-center justify-center border-r-1 border-brandDarkGreen px-10 py-10 lg:flex ">
            <div class="w-full text-left font-sourceCodepro text-sm text-gray-500">
          ...
          <div class="flex h-full w-full flex-col justify-between  py-10 lg:w-3/4 lg:px-10 ">
            <div class="  font-roboto text-5xl font-bold lg:text-8xl ">
              <span class="text-brandPink">Welcome </span>
              <span class="text-gray-800">to the Land of </span>

              <span class=" text-brandLightBlue">Ciphers</span>
            </div>
            <div class=" my-10 flex w-full flex-col items-center justify-center font-sourceCodepro lg:my-20 lg:flex-row">
              <div className=" flex w-full flex-col items-center justify-center py-5 font-sourceCodepro text-sm text-gray-500 hover:text-white lg:w-1/2 lg:px-5 ">
                <a
                  href="#ciphers"
